<?php if (!defined('THINK_PATH')) exit();?>﻿<div class="pageContent">
	<form method="post" action="/index.php/Home/Result/add_act_lc" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p style="width:100%"><strong><?php echo ($kjinfo["cz_name"]); ?>&nbsp;篮彩赛果录入信息</strong></p>
			<p style="width:100%">
				...
				<label style="width:200px;color:#999;">对阵编号格式：301</label>
			</p>
			<p style="width:100%">
