<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/index.php/Home/Result/lancai">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/index.php/Home/Result/lancai" method="post">
	<input type="hidden" name="act" value="query" />
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/index.php/Home/Result/add?act=lc" target="dialog" rel="lcresult" title="添加赛果"><span>添加赛果</span></a></li>
			<li><a class="edit" href="/index.php/Home/Result/view?recid={lotttime_ballid}&act=edit&source=lc" target="dialog" width="770" rel="editresult" title="修改赛果"><span>修改赛果</span></a></li>
		</ul>
	</div>
	<table class="table" width="100%" layoutH="113">
		...
		<tbody>
		    <?php if(is_array($resultlist)): foreach($resultlist as $key=>$res): ?><tr target="lotttime_ballid" rel="<?php echo ($res["lotttime"]); ?>_<?php echo ($res["ballid"]); ?>" >
				...
				<td><?php echo ($res["first_score"]); ?></td>
				<td><?php echo ($res["two_score"]); ?></td>
				<td><?php echo ($res["three_score"]); ?></td>
				<td><?php echo ($res["four_score"]); ?></td>
				<td><?php echo ($res["add_score"]); ?></td>
				<td><?php echo ($res["full_score"]); ?></td>
				<td><?php echo ($res["match_starttime"]); ?></td>
				<td><?php echo ($res["addtime"]); ?></td>
				<td><?php echo ($res["result"]); ?></td>
				<td><?php echo ($res["status"]); ?></td>
				<td><a href='/index.php/Home/Result/view?recid=<?php echo ($res["lotttime"]); ?>_<?php echo ($res["ballid"]); ?>&source=lc' target="dialog" width="750" title="查看赛果">查看</a>
