...
$yuhua_lotterycode="209^151211-002(3_1.84,1_3.40);209^151211-003(3_2.88)";
...
$base->assign('str',$str);
$base->assign('yuhua_schememoney',$lotteryvalue);//钱数
$base->assign('childtype',$yuhua_gate);//左边显示的投注信息
