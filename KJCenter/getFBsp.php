...
echo "--------------\n 开始抓取胜平负玩法SP值 \n";
$ResultObj->had();
echo "胜平负玩法 get sp data success,please wait 1s ... \n";
sleep(1);
echo "--------------\n开始抓取让球胜平负玩法SP值 \n";
$ResultObj->hhad();
echo "让球胜平负玩法 get sp data success,please wait 1s ... \n";
sleep(1);
echo "--------------\n开始抓取总进球玩法SP值 \n";
$ResultObj->ttg();
echo "总进球玩法 get sp data success,please wait 1s ... \n";
sleep(1);
echo "--------------\n开始抓取比分玩法SP值 \n";
$ResultObj->crs();
echo "比分玩法 get sp data success,please wait 1s ... \n";
sleep(1);
echo "--------------\n开始抓取半全场玩法SP值 \n";
$ResultObj->hafu();
echo "半全场玩法 get sp data success,please wait 1s ... \n";
